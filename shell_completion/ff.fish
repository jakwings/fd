...
complete -c ff -n "__fish_use_subcommand" -s M -l mount -d 'Do not descend into directories on other filesystems.'
...
complete -c ff -n "__fish_use_subcommand" -s h -l help -d 'Prints help information. Use --help for more details.'
