...
Register-ArgumentCompleter -Native -CommandName 'ff' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'ff' {
            ...
            [CompletionResult]::new('-M', 'M', [CompletionResultType]::ParameterName, 'Do not descend into directories on other filesystems.')
            [CompletionResult]::new('--mount', 'mount', [CompletionResultType]::ParameterName, 'Do not descend into directories on other filesystems.')
